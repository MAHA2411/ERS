...
const verifySubAdminFlow = async () => {
    try {
        ...
        // The controller calls: Admin.create({ ... })
        // We expect the pre-save hook to hash the password ONCE.
        ...
        // 4. Double Hash Check?
        // If double hashed, the hash would look like a hash, but comparing '123456' would fail.
        // If NOT hashed, it would be '123456'.
        if (subAdmin.password === testPass) {
            console.error("❌ CRITICAL: Password stored in PLAIN TEXT!");
        }
